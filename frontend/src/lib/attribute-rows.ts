 ...
 * Numbers and yes/no values keep their type; anything else the form cannot edit (null, nested
 * values, lists) keeps its original value in `raw`.
 */
